...
| 工具 | 功能 | 使用场景 |
|------|------|----------|
| `youtube_search` | 搜索 YouTube 视频 | 用户问"给我找 Claude Code 教程" |
| `youtube_get_video` | 获取视频详情 | 用户问"这个视频表现如何" |
| `youtube_get_comments` | 获取视频评论 | 用户问"大家对这个视频什么评价" |
| `youtube_get_channel` | 获取频道信息 | 用户问"这个频道有多少订阅" |
| `youtube_get_playlist` | 获取播放列表 | 用户问"这个列表有什么视频" |
| `youtube_get_transcript` | 获取视频字幕文本 | 用户问"总结这个视频" |
